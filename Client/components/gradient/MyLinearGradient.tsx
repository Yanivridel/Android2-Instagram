...
interface MyLinearGradientProps {
  ...
  color?: "blue" | "purple" | "blue-purple" | "light-blue" | "disabled-button" | "dark" | "gray" | "turquoise"
        | "turquoise-button";
  customColors?: string[];
...
const MyLinearGradient = ({ children, type, color, customColors, className}: MyLinearGradientProps) => {
  ...
  function getOptions(color: MyLinearGradientProps["color"]) {
    ...
    const gradientPositions = {
        ...
        "turquoise": { colors: ["#00C2B2", "#004F48"], start: [0, 1], end: [1, 0] },
        "turquoise-button": { colors: ["#00B3A6", "#007F78"], start: [0, 1], end: [1, 0] },
